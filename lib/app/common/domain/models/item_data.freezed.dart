...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ItemData&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description));
}
...
@override
String toString() {
  return 'ItemData(title: $title, description: $description)';
}
...
class _ItemData implements ItemData {
  const _ItemData({required this.title, required this.description});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ItemData&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description));
}
