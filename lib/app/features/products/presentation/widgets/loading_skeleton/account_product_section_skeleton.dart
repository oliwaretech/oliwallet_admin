...
class AccountProductSectionSkeleton extends StatefulWidget {
  const AccountProductSectionSkeleton({super.key});

  @override
  State<AccountProductSectionSkeleton> createState() =>
      _AccountProductSectionSkeletonState();
}

class _AccountProductSectionSkeletonState
    extends State<AccountProductSectionSkeleton> {
