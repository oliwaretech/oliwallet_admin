...
part of 'line_of_credit_pay_operation_data.dart';
...
/// @nodoc
mixin _$LineOfCreditPayOperationData {
...
/// @nodoc
abstract mixin class $LineOfCreditPayOperationDataCopyWith<$Res>  {
  factory $LineOfCreditPayOperationDataCopyWith(LineOfCreditPayOperationData value, $Res Function(LineOfCreditPayOperationData) _then) = _$LineOfCreditPayOperationDataCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$LineOfCreditPayOperationDataCopyWithImpl<$Res>
    implements $LineOfCreditPayOperationDataCopyWith<$Res> {
  _$LineOfCreditPayOperationDataCopyWithImpl(this._self, this._then);

  final LineOfCreditPayOperationData _self;
  final $Res Function(LineOfCreditPayOperationData) _then;
...
/// Adds pattern-matching-related methods to [LineOfCreditPayOperationData].
extension LineOfCreditPayOperationDataPatterns on LineOfCreditPayOperationData {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _LineOfCreditPayOperationData value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _LineOfCreditPayOperationData() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _LineOfCreditPayOperationData value)  $default,){
final _that = this;
switch (_that) {
case _LineOfCreditPayOperationData():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _LineOfCreditPayOperationData value)?  $default,){
final _that = this;
switch (_that) {
case _LineOfCreditPayOperationData() when $default != null:
return $default(_that);case _:
...
class _LineOfCreditPayOperationData implements LineOfCreditPayOperationData {
  const _LineOfCreditPayOperationData({this.amount, this.totalAmount, this.payAccountData, this.paymentType, this.transactionMethod, this.method, this.confirmationMethod, this.operationCode, @JsonKey(includeFromJson: false, includeToJson: false) this.proofImage, this.proofImageUrl, this.operationName, final  List<ChargesValues>? fees, final  List<ChargesValues>? taxes}): _fees = fees,_taxes = taxes;
  factory _LineOfCreditPayOperationData.fromJson(Map<String, dynamic> json) => _$LineOfCreditPayOperationDataFromJson(json);
...
@pragma('vm:prefer-inline')
_$LineOfCreditPayOperationDataCopyWith<_LineOfCreditPayOperationData> get copyWith => __$LineOfCreditPayOperationDataCopyWithImpl<_LineOfCreditPayOperationData>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$LineOfCreditPayOperationDataToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LineOfCreditPayOperationData&&(identical(other.amount, amount) || other.amount == amount)&&(identical(other.totalAmount, totalAmount) || other.totalAmount == totalAmount)&&(identical(other.payAccountData, payAccountData) || other.payAccountData == payAccountData)&&(identical(other.paymentType, paymentType) || other.paymentType == paymentType)&&(identical(other.transactionMethod, transactionMethod) || other.transactionMethod == transactionMethod)&&(identical(other.method, method) || other.method == method)&&(identical(other.confirmationMethod, confirmationMethod) || other.confirmationMethod == confirmationMethod)&&(identical(other.operationCode, operationCode) || other.operationCode == operationCode)&&(identical(other.proofImage, proofImage) || other.proofImage == proofImage)&&(identical(other.proofImageUrl, proofImageUrl) || other.proofImageUrl == proofImageUrl)&&(identical(other.operationName, operationName) || other.operationName == operationName)&&const DeepCollectionEquality().equals(other._fees, _fees)&&const DeepCollectionEquality().equals(other._taxes, _taxes));
}
...
/// @nodoc
abstract mixin class _$LineOfCreditPayOperationDataCopyWith<$Res> implements $LineOfCreditPayOperationDataCopyWith<$Res> {
  factory _$LineOfCreditPayOperationDataCopyWith(_LineOfCreditPayOperationData value, $Res Function(_LineOfCreditPayOperationData) _then) = __$LineOfCreditPayOperationDataCopyWithImpl;
@override @useResult
$Res call({
 BigInt? amount, BigInt? totalAmount, AccountData? payAccountData, PaymentType? paymentType, TransactionMethod? transactionMethod, Method? method, OperationConfirmationMethod? confirmationMethod, String? operationCode,@JsonKey(includeFromJson: false, includeToJson: false) File? proofImage, String? proofImageUrl, LanguageCodes? operationName, List<ChargesValues>? fees, List<ChargesValues>? taxes
});
...
/// @nodoc
class __$LineOfCreditPayOperationDataCopyWithImpl<$Res>
    implements _$LineOfCreditPayOperationDataCopyWith<$Res> {
  __$LineOfCreditPayOperationDataCopyWithImpl(this._self, this._then);

  final _LineOfCreditPayOperationData _self;
  final $Res Function(_LineOfCreditPayOperationData) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? amount = freezed,Object? totalAmount = freezed,Object? payAccountData = freezed,Object? paymentType = freezed,Object? transactionMethod = freezed,Object? method = freezed,Object? confirmationMethod = freezed,Object? operationCode = freezed,Object? proofImage = freezed,Object? proofImageUrl = freezed,Object? operationName = freezed,Object? fees = freezed,Object? taxes = freezed,}) {
  return _then(_LineOfCreditPayOperationData(
amount: freezed == amount ? _self.amount : amount // ignore: cast_nullable_to_non_nullable
as BigInt?,totalAmount: freezed == totalAmount ? _self.totalAmount : totalAmount // ignore: cast_nullable_to_non_nullable
as BigInt?,payAccountData: freezed == payAccountData ? _self.payAccountData : payAccountData // ignore: cast_nullable_to_non_nullable
as AccountData?,paymentType: freezed == paymentType ? _self.paymentType : paymentType // ignore: cast_nullable_to_non_nullable
