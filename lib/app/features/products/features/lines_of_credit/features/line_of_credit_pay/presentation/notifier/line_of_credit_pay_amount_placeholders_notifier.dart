...
class LineOfCreditPayAmountPlaceholdersNotifier
    extends StateNotifier<List<String>> {
  LineOfCreditPayAmountPlaceholdersNotifier(this._prefs) : super([]) {
    loadPlaceHolders();
  }

  final SharedPreferences _prefs;

  static const _key = 'line_of_credit_pay_amount_placeholders';
