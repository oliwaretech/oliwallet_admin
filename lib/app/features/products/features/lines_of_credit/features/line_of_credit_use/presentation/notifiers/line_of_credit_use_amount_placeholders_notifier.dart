...
class LineOfCreditUseAmountPlaceholdersNotifier
    extends StateNotifier<List<String>> {
  LineOfCreditUseAmountPlaceholdersNotifier(this._prefs) : super([]) {
    loadPlaceHolders();
  }

  final SharedPreferences _prefs;

  static const _key = 'line_of_credit_use_amount_placeholders';
