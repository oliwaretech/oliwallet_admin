...
class LoanPayOperationNotifier extends StateNotifier<LoanPayOperationData> {
  LoanPayOperationNotifier() : super(const LoanPayOperationData());
  ...
  // Clear all data
  void clear() {
    state = const LoanPayOperationData();
  }
}
