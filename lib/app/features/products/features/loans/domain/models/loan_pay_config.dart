...
part 'loan_pay_config.freezed.dart';
part 'loan_pay_config.g.dart';

@freezed
abstract class LoanPayConfig with _$LoanPayConfig {
  @JsonSerializable(fieldRename: FieldRename.snake)
  const factory LoanPayConfig({
  ...
  factory LoanPayConfig.fromJson(Map<String, dynamic> json) =>
      _$LoanPayConfigFromJson(json);
}
