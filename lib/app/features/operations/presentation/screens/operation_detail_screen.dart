...
class OperationDetailScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final getUserOperationDataAsyncValue = ref.watch(getUserOperationDataProvider(operation.userId));
         ...
         return getUserOperationDataAsyncValue.when(
           data: (userOperationData){
             ...
             if(operation.creditCardCashOperationData != null){
               operationDetailSection = OperationDetailCreditCardCashSection(operation: operation, appConfig: appConfig, userData: userOperationData,);
             }
             else if(operation.depositOperationData != null){
               operationDetailSection = OperationDetailDepositSection(operation: operation, appConfig: appConfig, userData: userOperationData,);
             }
             else if(operation.withdrawalOperationData != null){
               operationDetailSection = OperationDetailWithdrawalSection(operation: operation, appConfig: appConfig, userData: userOperationData,);
             }
             else if(operation.lineOfCreditPayOperationData != null){
               operationDetailSection = OperationDetailLineOfCreditPaySection(operation: operation, appConfig: appConfig, userData: userOperationData,);
             }
             else if(operation.lineOfCreditUseOperationData != null){
               operationDetailSection = OperationDetailLineOfCreditUseSection(operation: operation, appConfig: appConfig, userData: userOperationData,);
             }
             else if(operation.loanPayOperationData != null){
               operationDetailSection = OperationDetailLoanPaySection(operation: operation, appConfig: appConfig, userData: userOperationData,);
             }
             else if(operation.loanUseOperationData != null){
               operationDetailSection = OperationDetailLoanUseSection(operation: operation, appConfig: appConfig, userData: userOperationData,);
             }
             else {
                         ...
                         children: [
                           ...
                           Column(
                             ...
                             children: [
                               ...
                               Text('${appLocalizations.operationDate}: ${DateFormatter.formatFromIso(
                                 operation.updatedAt!,
                                 includeTime: true,
                               )}', style: OlwTextStyles.textFieldLabel,),
                               Text(operation.operationCode!, style: OlwTextStyles.textFieldLabel,),
                             ],
                           ),
