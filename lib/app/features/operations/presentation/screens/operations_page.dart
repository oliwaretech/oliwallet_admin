...
class OperationsPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final getOperationsAsyncValue = ref.watch(
        ...
        child: Column(
          ...
          children: [
            ...
            OlwTabSelector(
              ...
              onTabSelected: (value) {
                ref
                    .read(currentOperationTabProvider.notifier)
                    .state = OperationStatus.values.firstWhere(
                    ...
                    if (operations.isEmpty)
                      Center(
                        child: EmptyStateContent(
                          title: appLocalizations.thereAreNotOperationsToShow,
                        ),
                      ),
              ...
              error: (error, stackTrace) {
                return OlwErrorScreen(
                  ...
                  onPrimaryButtonPressed: () =>
                      ref.refresh(getOperationsProvider(currentOperationTab)),
                );
              },
              loading: () => Center(child: OlwLoadingSpinner()),
            ),
          ],
        ),
      ),
