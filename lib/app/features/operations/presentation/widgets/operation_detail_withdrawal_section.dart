...
class OperationDetailWithdrawalSection extends ConsumerWidget {
  ...
  const OperationDetailWithdrawalSection({super.key,
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(OlwFormatter.currency(BigIntParser.toDouble(withdrawalOperationData.totalAmount!), symbol: operation.currencySymbol), style: OlwTextStyles.textTitle,),
                SizedBox(
                  height: 8,
                ),
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ClipOval(
                        child: Image.network(
                          withdrawalOperationData.externalMethod!.entityImageUrl!,
                          width: 40,
                          height: 40,
                          fit: BoxFit.fill,
                        ),
                      ...
                      Column(
                        ...
                        children: [
                          Row(
                            spacing: 8,
                            children: [
                              Text(withdrawalOperationData.externalMethod!.entityName!.getLocalized(appLocalizations.localeName), style: OlwTextStyles.textCardTitle,),
                              if(withdrawalOperationData.externalMethod!.accountType != null)
                                Text(withdrawalOperationData.externalMethod!.accountType!.accountTypeName.getLocalized(appLocalizations.localeName), style: OlwTextStyles.textDescription,),
                            ],
                          ),
                          if(withdrawalOperationData.externalMethod!.accountNumber != null)
                            Row(
                              children: [
                                Text('A.C: ', style: OlwTextStyles.textDescription,),
                                Text(withdrawalOperationData.externalMethod!.accountNumber!, style: OlwTextStyles.textDescription,),
                                SizedBox(width: 8,),
                                OlwIconButton(
                                    onPressed: () {
                                      copyToClipboard(
                                        ...
                                        withdrawalOperationData.externalMethod!.accountNumber!,
                                      );
                                    },
                                    iconPath: IconAssets.copy)
                              ],
                            ),
                          if(withdrawalOperationData.externalMethod!.interbankAccountNumber != null)
                            Row(
                              children: [
                                Text('CCI: ', style: OlwTextStyles.textDescription,),
                                Text(withdrawalOperationData.externalMethod!.interbankAccountNumber!, style: OlwTextStyles.textDescription,),
                                SizedBox(width: 8,),
                                OlwIconButton(
                                    onPressed: () {
                                      copyToClipboard(
                                        ...
                                        withdrawalOperationData.externalMethod!.interbankAccountNumber!,
                                      );
                                    },
                                    iconPath: IconAssets.copy)
                              ],
                            ),
                          if(withdrawalOperationData.externalMethod!.phoneNumber != null)
                            Row(
                              children: [
                                Text('${appLocalizations.mobilePhone}: ', style: OlwTextStyles.textDescription,),
                                Text(withdrawalOperationData.externalMethod!.phoneNumber!, style: OlwTextStyles.textDescription,),
                                SizedBox(width: 8,),
                                OlwIconButton(
                                    onPressed: () {
                                      copyToClipboard(
                                        ...
                                        withdrawalOperationData.externalMethod!.phoneNumber!,
                                      );
                                    },
                                    iconPath: IconAssets.copy)
                              ],
        ...
        Column(
          children: [
            ...
            OperationDetailTile(
                ...
                value: OlwFormatter.currency(BigIntParser.toDouble(withdrawalOperationData.accountData!.balance), symbol: operation.currencySymbol)
            ),
            OperationDetailTile(
                item: appLocalizations.balanceAfterWithdrawal,
                value: OlwFormatter.currency(BigIntParser.toDouble(withdrawalOperationData.accountData!.balance - withdrawalOperationData.totalAmount!), symbol: operation.currencySymbol)
            ),
          ],
        ),
        ...
        Column(
          children: [
            OperationDetailTile(
              ...
              value: OlwFormatter.currency(BigIntParser.toDouble(withdrawalOperationData.amount!), symbol: operation.currencySymbol),),
            OperationDetailTile(
            ...
            OperationDetailTile(
                ...
                valueWidget: OlwTag(label: OlwFormatter.currency(BigIntParser.toDouble(withdrawalOperationData.totalAmount!), symbol: operation.currencySymbol))),
          ],
        ),
                ...
                OlwPrimaryButton(
                    onPressed: () {
                      updateOperationStatus(
                          ...
                          userData.currentCountryCode == 'PE' ? appConfig.messageNotificationConfig.pe.withdrawal : appConfig.messageNotificationConfig.hr!.withdrawal,
                          appLocalizations
                      );
                    },
  ...
  Future<void> updateOperationStatus(WidgetRef ref,
    ...
    try {
      ...
      await ref.read(operationsRepositoryProvider).updateOperationStatus(operationId, status, SupabaseTables.transactionOperations);
        ...
        if(userData.currentCountryCode == 'PE'){
          await appFeaturesRepository.createPushNotification(
              PushNotificationData(
                ...
                body: '${messageNotificationData.completedOperation.body.es} ${withdrawalOperationData.externalMethod!.entityName!.es}',
                type: PushNotificationTypes.withdrawalRequest,
              )
          );
          messageContent = '${messageNotificationData.completedOperation.greeting.es} ${userData.name}, ${messageNotificationData.completedOperation.body.es} ${withdrawalOperationData.externalMethod!.entityName!.es} ${messageNotificationData.completedOperation.suffix}';
        } else {
          await appFeaturesRepository.createPushNotification(
              PushNotificationData(
                title: 'Operation Completed',
                userId: userData.userId!,
                body: '${messageNotificationData.completedOperation.body.en} ${withdrawalOperationData.externalMethod!.entityName!.en}',
                type: PushNotificationTypes.withdrawalRequest,
              )
          );
          messageContent = '${messageNotificationData.completedOperation.greeting.en} ${userData.name}, ${messageNotificationData.completedOperation.body.en} ${withdrawalOperationData.externalMethod!.entityName!.en} ${messageNotificationData.completedOperation.suffix}';
        }
