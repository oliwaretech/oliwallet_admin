...
class OperationDetailCreditCardCashSection extends ConsumerWidget {
  ...
  const OperationDetailCreditCardCashSection({
    super.key,
        ...
        OlwCard(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  appLocalizations.totalAmountToDisburse,
                  style: OlwTextStyles.textSubTitle,
                ),
                Text(
                  OlwFormatter.currency(
                    BigIntParser.toDouble(creditCardCashOperationData.amount!),
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              if (creditCardCashOperationData
                                      .externalMethod!
                                      .accountType !=
                                  null)
                                Text(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                if (creditCardCashOperationData.confirmationMethod ==
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        creditCardCashOperationData.operationCode!,
                        style: OlwTextStyles.textCardTitle,
                      ),
                    ],
                  ),
                    ...
                    onPressed: () {
                      showOlwBottomSheet(
                        ...
                        content: InteractiveViewer(
                          ...
                          maxScale: 4.0,
                          child: Image.network(
                            creditCardCashOperationData.proofImageUrl!,
                            fit: BoxFit.contain,
                          ),
                        ),
                      );
        ...
        Column(
          children: [
            OperationDetailTile(
              ...
              value: creditCardCashOperationData
                  .creditCardCashMethod!
                  .methodName
                  .getLocalized(appLocalizations.localeName),
            ),
          ],
          ...
          children: [
            OperationDetailTile(
              ...
              value: OlwFormatter.currency(
                BigIntParser.toDouble(creditCardCashOperationData.totalAmount!),
                symbol: operation.currencySymbol,
              ),
            ),
            OperationDetailTile(
    ...
    try {
      ...
      await ref
          ...
          .updateOperationStatus(
            operationId,
            status,
            SupabaseTables.creditCardCashOperations,
          );
      ...
      if (status == OperationStatus.completed) {
        if (userData.userPreferencesData?.languageCode == 'es') {
          messageContent =
              '${messageNotificationData.completedOperation.greeting.es} ${userData.name}, ${messageNotificationData.completedOperation.body.es} ${creditCardCashOperationData.externalMethod!.entityName!.es} ${messageNotificationData.completedOperation.suffix.getLocalized(appLocalizations.localeName)}';
          await appFeaturesRepository.createPushNotification(
            PushNotificationData(
              title: 'Operación Completada',
              userId: userData.userId!,
              body:
                  '${messageNotificationData.completedOperation.body.es} ${creditCardCashOperationData.externalMethod!.entityName!.es}',
              type: PushNotificationTypes.creditCardCashRequest,
            ),
          );
        } else {
          messageContent =
              '${messageNotificationData.completedOperation.greeting.en} ${userData.name}, ${messageNotificationData.completedOperation.body.en} ${creditCardCashOperationData.externalMethod!.entityName!.en} ${messageNotificationData.completedOperation.suffix.getLocalized(appLocalizations.localeName)}';
          await appFeaturesRepository.createPushNotification(
            PushNotificationData(
              title: 'Operation Completed',
              userId: userData.userId!,
              body:
                  '${messageNotificationData.completedOperation.body.en} ${creditCardCashOperationData.externalMethod!.entityName!.en}',
              type: PushNotificationTypes.creditCardCashRequest,
            ),
          );
        }
