...
class DepositAmountPlaceholdersNotifier extends StateNotifier<List<String>> {
  DepositAmountPlaceholdersNotifier(this._prefs) : super([]) {
    loadPlaceHolders();
  }

  final SharedPreferences _prefs;

  static const _key = 'deposit_amount_placeholders';
